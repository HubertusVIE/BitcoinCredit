...
pub mod tests {
    ...
    fn get_service(
        mock_storage: MockBillStoreApiMock,
        mock_chain_storage: MockBillChainStoreApiMock,
        ...
        mock_contact_storage: MockContactStoreApiMock,
    ...
    fn get_storages() -> (
        ...
        let mut identity_chain_store = MockIdentityChainStoreApiMock::new();
        let mut company_chain_store = MockCompanyChainStoreApiMock::new();
            ...
            let offer_to_sell_block = BillBlock::create_block_for_offer_to_sell(
                ...
                &BillOfferToSellBlockData {
                    seller: IdentityPublicData::new(get_baseline_identity().identity)
                        .unwrap()
                        .into(),
                    buyer: identity_public_data_only_node_id(bill.drawee.node_id.clone()).into(),
                    currency: "sat".to_string(),
                    sum: 15000,
            ...
            let offer_to_sell_block = BillBlock::create_block_for_offer_to_sell(
                ...
                &BillOfferToSellBlockData {
                    seller: IdentityPublicData::new(get_baseline_identity().identity)
                        .unwrap()
                        .into(),
                    buyer: identity_public_data_only_node_id(buyer_node_id.clone()).into(),
                    currency: "sat".to_string(),
                    sum: 15000,
                    payment_address: "1234paymentaddress".to_string(),
                    signatory: None,
